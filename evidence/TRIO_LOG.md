...
| TODO 1 - next head | 盧一君 | 黃皆益 | 吳赫宥 | `next_head` 測試全數亮綠燈 | 提交 PR，並切換分支準備實作 TODO 2 |
| TODO 2 - food | 黃皆益 | 吳赫宥 | 盧一君 | `ate_food` 測試全數亮綠燈 | 提交 PR，並切換分支準備實作 TODO 3 |
| TODO 3 - wall | 吳赫宥 | 盧一君 | 黃皆益 | `hit_wall` 邊界測試亮綠燈 | 提交 PR，並切換分支準備實作 TODO 4 |
| TODO 4 - body | 盧一君 | 黃皆益 | 吳赫宥 | `advance_body` 測試與整合測試皆通過 | 提交 PR，準備啟動 Pygame 進行實機遊玩 |
| Playable run | | | | | |
